...
* Manipulate measured acoustic signal to estimate breathing rate 

## Prelab Exercises: Understanding FMCW Signal
...
* What is the slope of TX signal (which is the same as the slope of RX signal) in terms of Bandwidth B and Chirp duration T? <span style="color:blue">[Put your answer here]</span>
